    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                email = (TextView) itemView.findViewById(R.id.drawer_user_email);       // Creating Text View object from header.xml for email
                profile = (ImageView) itemView.findViewById(R.id.drawer_user_image);// Creating Image view object from header.xml for profile pic
